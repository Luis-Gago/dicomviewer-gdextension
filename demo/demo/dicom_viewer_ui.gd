...
# UI References
@onready var dicom_viewer: DicomViewer = $DicomViewer
@onready var file_dialog: FileDialog = $FileDialog
@onready var folder_dialog: FileDialog = $FolderDialog
@onready var window_slider: HSlider = $VBoxContainer/WindowControl/WindowSlider
@onready var level_slider: HSlider = $VBoxContainer/LevelControl/LevelSlider
@onready var window_label: Label = $VBoxContainer/WindowControl/WindowLabel
@onready var level_label: Label = $VBoxContainer/LevelControl/LevelLabel
@onready var file_index_label: Label = $VBoxContainer/FileInfo/FileIndexLabel
...
func load_current_file() -> void:
    ...
    if success:
        ...
        # Update sliders to match loaded image's window/level
...
func _on_zoom_in_button_pressed() -> void:
    dicom_viewer.zoom_in()

func _on_zoom_out_button_pressed() -> void:
    dicom_viewer.zoom_out()
...
# Mouse wheel scrolling through files
